...
Design = an EXACT mirror of backbone-sweep Arm B (wrn28_10_plain_fedavg): same
...
CAMPAIGN = "cifar_fedprox_sweep"
OUT = "results/cifar_fedprox_sweep"
DATASETS = {"cifar10": 6, "cifar100": 60}
BACKBONE = "wrn28_10"
FEDPROX_MU = 0.1
ARM = f"wrn28_10_fedprox_mu{FEDPROX_MU:g}"
PIPELINE = "CIFAR_WRN28_10_FEDPROX"
            ...
            for rep in range(N_REPS):
                ...
                for d in CIFAR_D:
                    ...
                    rows.append(dict(
                        ...
                        paired_arm_b=f"wrn28_10_plain_fedavg__{ds}__split{i:02d}__seed{rep}__d{d}",
                        **seeds(block)))
