...
CAMP = os.path.join(REPO, "results", "cifar_resnext_fedprox_sweep")
MATRIX = os.path.join(CAMP, "final_training_matrix.csv")
MATRIX_SHA256 = "cf0f32362ec08d791fcabe83a89d626dbe9de9ce1790b3ea64c975f93091de17"
LIVE = os.path.join(CAMP, "live")
RUNS_DEFAULT = os.path.join(REPO, "runs", "cifar_resnext_fedprox_sweep", "cells")
...
CANARY_IDS = [
    "resnext29_8x64d_fedprox_mu0.1__cifar10__split00__seed0__d0.1",
    "resnext29_8x64d_fedprox_mu0.1__cifar100__split00__seed0__d0.1",
]
...
def build_docker_cmd(cell, paths, gpu_uuid, resume):
    cname = "cifrx_" + cell["semantic_id"].replace(".", "_").replace("/", "_")[:100]
...
def kill_orphan_containers():
    try:
        out = subprocess.run(["docker", "ps", "-q", "--filter", "name=cifrx_"],
