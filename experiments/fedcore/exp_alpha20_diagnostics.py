...
CELLS = [
    ("resnet18gn", "5",   "runs/cifar10_d5_resnet18gn_none0.0_seed{s}_logits.npz", (0, 1, 2, 3, 4), "msp"),
    ("resnet18gn", "0.5", "runs/cifar10_d0.5_resnet18gn_none0.0_seed{s}_logits.npz", (0, 1, 2, 3, 4), "msp"),
    ("resnet18",   "5",   "runs/cifar10_d5_resnet18_seed{s}_logits.npz", (0, 1, 2, 3, 4), "msp"),
